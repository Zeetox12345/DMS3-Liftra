...
def trans_create(p):
    ...
    with open("trans_file.txt","w") as file:
        ...
        file.write("ALLSEL,ALL \n")
        # Base Units for film coeff are "W"/m2K" - converts to W/mm2K by dividing with 1e-6
        file.write("SF,ALL,CONV,7.9*1e-6,19 \n") 

        # SOLVER AND TIME STEP OPTIONS
        file.write("\n!--- Time step options --- \n") # Time Step Option

        file.write("THOPT,QUASI \n")


        file.write("AUTOTS,OFF \n")
        file.write("DELTIM,0.1 \n") # Time Step of 0.5 sec
        ...
        # Goldack Parameters
        file.write("!---Source Parameters [mm]--- \n")
        file.write("A = 3.0 \n")
        file.write("B = 4.0 \n")
        file.write("C1 = 4.0 \n")
        file.write("C2 = 16.0 \n")
        ...
        file.write(f"VEL_1 = {Weld_vel:.4g} \n \n") # Welding Velocity for Pass 1
        ...
        file.write(f"time_weld_pass_1 = {time_weld_pass_1:.4g} \n") # Weld time for Pass 1
        file.write(f"break_weld_pass_1 = {break_weld_pass_1:.4g} ! s \n") # Break for Pass 1
        ...
        file.write(f"TBASE1 = {TBASE1:.4g} \n")
        file.write(f"END1 = {END1:.4g} \n")
