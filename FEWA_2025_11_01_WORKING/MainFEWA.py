...
def main():
    ...
    with open("UsrInput.txt","r") as file:
        for line in file:
            ...
            if "=" in line:
                ...
                variables[name.strip()] = eval(value.strip())
    ...
    with open("Runfile.txt", "w") as file:
        ...
        file.write("! Metric (mm,kg,N,s,C) \n")
        file.write("! LENFACT, MASSFACT, TIMEFACT, TEMPFACT, TOFFSET, CHARGEFACT, FORCEFACT, HEATFACT \n ")
        file.write("/Units,USER,0.001, 1, 1, 1, 273.15, 1, 1, 1 \n")
        file.write("/PREP7\n") 
